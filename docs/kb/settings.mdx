...
The `settings` part of you [FAB config](/kb/configuration) is used to provide both **production and non-production settings** that are injected at runtime to your FAB. For example:
