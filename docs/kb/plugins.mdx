...
export const build: FabBuildStep = async (args: MyPluginArgs, proto_fab: ProtoFab<MyPluginMetadata>) => {
  // Make changes to proto_fab
}

export const runtime: FabPluginRuntime = (args: MyPluginArgs, metadata: MyPluginMetadata) => {
