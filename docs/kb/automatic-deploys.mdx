...
As each FAB is a [production artefact](/kb/production), configuring a cloud-based tool to build & generate FABs means that hosting per-commit previews becomes trivial.

## Automatic releases

Make merging a PR your trigger
