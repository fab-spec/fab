...
```js
// proxy-api.js
export default function ProxyApi(Runtime) {
...
export default function GeolocateEndpoint(Runtime: FABRuntime) {
...
export default function AttachFabID(Runtime: FABRuntime) {
